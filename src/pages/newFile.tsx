...
import { pagetitle, identity, skills, happy, goal, finished } from './about.astro';
...
<Fragment><li>Dos de mis aficiones son: {identity.hobbies[0]} y {identity.hobbies[1]}</li></Fragment>}
</ul>
...
{goal === 3 ? <Fragment><p>Mi objetivo es terminar en 3 días.</p></Fragment> : finished && <Fragment><p>¡He terminado este tutorial!</p></Fragment>}
